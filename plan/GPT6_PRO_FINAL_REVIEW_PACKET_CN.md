...
1. `paper/value_only/main_cn.md`：当前 CalibTM v3 主论文。
2. `paper/value_only/SUPPLEMENTARY_RESULTS_CN.md`：主要结果与效率证据。
3. `plan/CALIBTM_V4_MODULE_BAKEOFF_PROTOCOL_2026-09-11_CN.md`：拟执行的 v4 模块实验协议。
4. `plan/CALIBTM_V4_NOVELTY_EXPLORATION_2026-09-11_CN.md`：GapCalib 的创新定位与近邻风险。
